...
const UPCOMING = [
  ...
  },
  {
    type: 'artist',
    name: 'Rob Soule',
    tagline: 'Soulful melodies meet hard-hitting bars',
    date: 'Coming Soon',
    icon: Music,
  ...
  },
  {
    type: 'artist',
    name: 'TTD Dex',
    tagline: 'Part of the TTD collective',
    date: 'Coming Soon',
    icon: Music,
  ...
  {
    type: 'merch',
    name: 'Agressive Heights Clothing',
  ...
  },
  {
    type: 'merch',
    name: 'Noble Naturals',
    tagline: 'Handcrafted candles & wax melts',
    date: 'Spring 2026',
    icon: Sparkles,
