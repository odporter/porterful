        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-[#1a1a1a] rounded-2xl p-8 border border-gray-800">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-bold mb-4 text-[#ff6b00]">Artist Merch</h3>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-400">Artist keeps:</span>
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-400">Business keeps:</span>
                    <span className="font-semibold">67%</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Artist + Platform:</span>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-[#1a1a1a] rounded-xl p-6 border border-gray-700">
              ...
              <p className="text-gray-500 mb-4">0-10 referrals</p>
            ...
            <div className="bg-[#1a1a1a] rounded-xl p-6 border border-purple-500/50">
              <div className="text-3xl mb-2">💜</div>
            ...
            <div className="bg-gradient-to-b from-[#ff6b00]/20 to-[#1a1a1a] rounded-xl p-6 border border-[#ff6b00]">
              ...
              <p className="text-[#ff6b00] mb-4">51+ referrals</p>
              <ul className="space-y-2 text-sm text-gray-400">
