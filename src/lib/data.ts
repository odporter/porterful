...
export const TRACKS = [
  ...
  { id: 'stl-01', title: 'Aint Gone Let Up', artist: 'Jai Jai', album: 'Streets Thought I Left', duration: '3:15', price: 1, plays: 125000, image: ALBUM_ART.StreetsThoughtILeft, audio_url: audio('StreetsThoughtILef', 'Jai Jai - Aint Gone Let Up.mp3') },
  { id: 'stl-02', title: 'Aired Em Out', artist: 'Jai Jai', album: 'Streets Thought I Left', duration: '2:45', price: 1, plays: 98000, image: ALBUM_ART.StreetsThoughtILeft, audio_url: audio('StreetsThoughtILef', 'Jai Jai - Aired Em Out.mp3') },
  { id: 'stl-03', title: 'Forever Young', artist: 'Jai Jai', album: 'Streets Thought I Left', duration: '3:58', price: 1, plays: 76000, image: ALBUM_ART.StreetsThoughtILeft, audio_url: audio('StreetsThoughtILef', 'Jai Jai - Forever Young.mp3') },
  { id: 'stl-04', title: 'Intro To My World', artist: 'Jai Jai', album: 'Streets Thought I Left', duration: '2:22', price: 1, plays: 89000, image: ALBUM_ART.StreetsThoughtILeft, audio_url: audio('StreetsThoughtILef', 'Jai Jai -  Intro To My World.mp3') },
  { id: 'stl-05', title: 'Sometime', artist: 'Jai Jai', album: 'Streets Thought I Left', duration: '3:45', price: 1, plays: 54000, image: ALBUM_ART.StreetsThoughtILeft, audio_url: audio('StreetsThoughtILef', 'Jai Jai - Sometime.mp3') },
  { id: 'stl-06', title: 'Cutta Money', artist: 'Jai Jai', album: 'Streets Thought I Left', duration: '3:12', price: 1, plays: 67000, image: ALBUM_ART.StreetsThoughtILeft, audio_url: audio('StreetsThoughtILef', 'Jai Jai - Cutta Money.mp3') },
  { id: 'stl-07', title: 'Issues', artist: 'Jai Jai', album: 'Streets Thought I Left', duration: '4:01', price: 1, plays: 45000, image: ALBUM_ART.StreetsThoughtILeft, audio_url: audio('StreetsThoughtILef', 'Jai Jai - Issues.mp3') },
  { id: 'stl-08', title: 'Bounce Dat Azz', artist: 'Jai Jai', album: 'Streets Thought I Left', duration: '2:58', price: 1, plays: 82000, image: ALBUM_ART.StreetsThoughtILeft, audio_url: audio('StreetsThoughtILef', 'Jai Jai - Bounce Dat Azz.mp3') },
  { id: 'stl-09', title: 'On Errthang', artist: 'Jai Jai', album: 'Streets Thought I Left', duration: '3:33', price: 1, plays: 71000, image: ALBUM_ART.StreetsThoughtILeft, audio_url: audio('StreetsThoughtILef', 'Jai Jai - On Errthang.mp3') },
  { id: 'stl-10', title: '18 Facts Of Life', artist: 'Jai Jai', album: 'Streets Thought I Left', duration: '3:45', price: 1, plays: 55000, image: ALBUM_ART.StreetsThoughtILeft, audio_url: audio('StreetsThoughtILef', '18 18 Facts Of Life.mp3') },
  ...
  { id: 'rox-04', title: 'Spoken Wordz', artist: 'O D Porter', album: 'Roxannity', duration: '3:56', price: 1, plays: 51000, image: ALBUM_ART.Roxannity, audio_url: audio('Roxannity', '04 Spoken Wordz.mp3') },
  ...
  { id: 'rox-11', title: 'Outsider', artist: 'O D Porter', album: 'Roxannity', duration: '3:15', price: 1, plays: 38000, image: ALBUM_ART.Roxannity, audio_url: audio('Roxannity', '12 Outsider.mp3') },
  { id: 'rox-12', title: 'You Better Stop', artist: 'O D Porter', album: 'Roxannity', duration: '3:04', price: 1, plays: 52000, image: ALBUM_ART.Roxannity, audio_url: audio('Roxannity', '14 You Better Stop.mp3') },
  { id: 'rox-13', title: 'Rose', artist: 'O D Porter', album: 'Roxannity', duration: '4:05', price: 1, plays: 44000, image: ALBUM_ART.Roxannity, audio_url: audio('Roxannity', '15 Rose.mp3') },
  { id: 'rox-14', title: 'My Testamony', artist: 'O D Porter', album: 'Roxannity', duration: '2:30', price: 1, plays: 36000, image: ALBUM_ART.Roxannity, audio_url: audio('Roxannity', '16 My Testamony.mp3') },
  ...
  { id: 'lev-01', title: 'Decomposure', artist: 'Jai Jai', album: 'Levi', duration: '2:45', price: 1, plays: 45000, image: ALBUM_ART.Levi, audio_url: audio('Levi', 'Jai Jai - Decomposure (LEVI 501 Vol.1).mp3') },
  { id: 'lev-02', title: 'Hero', artist: 'Jai Jai', album: 'Levi', duration: '4:01', price: 1, plays: 67000, image: ALBUM_ART.Levi, audio_url: audio('Levi', 'Jai Jai - Hero (LEVI 501 Vol.1).mp3') },
  { id: 'lev-03', title: 'Keep It Real', artist: 'Jai Jai', album: 'Levi', duration: '3:22', price: 1, plays: 52000, image: ALBUM_ART.Levi, audio_url: audio('Levi', 'Jai Jai - Keep It Real (LEVI 501 Vol.1).mp3') },
  { id: 'lev-04', title: 'Lifestyle', artist: 'Jai Jai', album: 'Levi', duration: '3:45', price: 1, plays: 58000, image: ALBUM_ART.Levi, audio_url: audio('Levi', 'Jai Jai - Lifestyle (LEVI 501 Vol.1).mp3') },
  { id: 'lev-05', title: 'Lust', artist: 'Jai Jai', album: 'Levi', duration: '2:58', price: 1, plays: 41000, image: ALBUM_ART.Levi, audio_url: audio('Levi', 'Jai Jai - Lust (LEVI 501 Vol.1).mp3') },
  { id: 'lev-06', title: 'No Limits', artist: 'Jai Jai', album: 'Levi', duration: '4:12', price: 1, plays: 63000, image: ALBUM_ART.Levi, audio_url: audio('Levi', 'Jai Jai - No Limits (LEVI 501 Vol.1).mp3') },
  { id: 'lev-07', title: 'Only Real Niggaz', artist: 'Jai Jai', album: 'Levi', duration: '3:55', price: 1, plays: 47000, image: ALBUM_ART.Levi, audio_url: audio('Levi', 'Jai Jai - Only Real Niggaz (LEVI 501 Vol.1).mp3') },
  { id: 'lev-08', title: 'Outsider', artist: 'Jai Jai', album: 'Levi', duration: '3:28', price: 1, plays: 39000, image: ALBUM_ART.Levi, audio_url: audio('Levi', 'Jai Jai - Outsider (LEVI 501 Vol.1).mp3') },
  { id: 'lev-09', title: 'Spoken Word', artist: 'Jai Jai', album: 'Levi', duration: '4:45', price: 1, plays: 55000, image: ALBUM_ART.Levi, audio_url: audio('Levi', 'Jai Jai - Spoken Word (LEVI 501 Vol.1).mp3') },
  // GUNE TRACKS
